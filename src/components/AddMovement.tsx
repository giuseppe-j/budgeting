                            ...
                            <div className="w-full">
                                <form onSubmit={onSubmit}>
                                    ...
                                    <div className="mb-4">
                                        ...
                                        <div className="relative">
                                            <select
                                                className="block appearance-none w-full capitalize border border-gray-200 text-gray-700 py-3 px-3 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                                                {...register("category", {
                                                    required: true,
                                                })}
                                            >
                                                <option value="">-</option>
                                                <option
                                                    value={Constants.SHOPPING}
                                                >
                                                    {Constants.SHOPPING}
                                                </option>
                                                <option
                                                    value={Constants.UTILITIES}
                                                >
                                                    {Constants.UTILITIES}
                                                </option>
                                                <option
                                                ...
                                                <option
                                                    value={Constants.WELLNESS}
                                                >
                                                    {Constants.WELLNESS}
                                                </option>
                                                <option
                                                    value={Constants.SALARY}
                                                >
                                                    {Constants.SALARY}
                                                </option>
                                            </select>
